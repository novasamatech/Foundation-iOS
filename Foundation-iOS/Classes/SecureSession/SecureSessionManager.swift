...
public enum SecureSessionManagerError: Error {
...
extension SecureSessionManager: SecureSessionManaging {
    public func startSession() throws -> SecureSession.PublicKey {
    ...
    public func deriveCryptor(peerPubKey: SecureSession.PublicKey) throws -> SecureSessionCrypting {
