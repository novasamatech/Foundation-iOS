...
public protocol WalletMigrationOriginProtocol {
...
extension WalletMigrationOrigin: WalletMigrationOriginProtocol {
    public func start(with message: WalletMigrationMessage.Start) throws {
    ...
    public func complete(with message: WalletMigrationMessage.Complete) throws {
